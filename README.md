...
```html
<script src="https://cdn.rawgit.com/Nangue-Tasse/generis2d/fa6e7ab/generis2d.min.js"></script>
```
...
<html>
  <head> 
    <script type="text/javascript" src="https://cdn.rawgit.com/Nangue-Tasse/generis2d/fa6e7ab/generis2d.min.js"></script>   
  </head>
