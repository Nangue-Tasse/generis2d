...
/*
* Copyright (c) 2015-2016 Geraud NT http://www.generisengine.appspot.com
*
...
/*
* Core.js
* Helper functions with various definitions for Class objects.
*/ 
/* Start */
function copy(t){if(!t||"object"!=typeof t||t instanceof Class)return t;if(t instanceof Array){for(var n=[],r=0,i=t.length;i>r;r++)n[r]=copy(t[r]);return n}var n={};for(var r in t)n[r]=copy(t[r]);return n}function ksort(t){if(!t||"object"!=typeof t)return[];var n=[],r=[];for(var i in t)n.push(i);n.sort();for(var i=0;i<n.length;i++)r.push(t[n[i]]);return r}Array.prototype.erase=function(t){for(var n=this.length;n--;n)this[n]===t&&this.splice(n,1);return this},Function.prototype.bind=function(t){var n=this;return function(){var r=Array.prototype.slice.call(arguments);return n.apply(t||null,r)}},merge=function(t,n){for(var r in n){var i=n[r];"object"!=typeof i||i instanceof Class?t[r]=i:(t[r]&&"object"==typeof t[r]||(t[r]={}),merge(t[r],i))}return t},function(){var t=!1,n=/xyz/.test(function(){xyz})?/\bparent\b/:/.*/;this.Class=function(){};var r=function(t){var r=this.prototype,i={};for(var e in t)"function"==typeof t[e]&&"function"==typeof r[e]&&n.test(t[e])?(i[e]=r[e],r[e]=function(t,n){return function(){var r=this.parent;this.parent=i[t];var e=n.apply(this,arguments);return this.parent=r,e}}(e,t[e])):r[e]=t[e]};this.Class.extend=function(i){function e(){if(!t){if(this.staticInstantiate){var n=this.staticInstantiate.apply(this,arguments);if(n)return n}for(var r in this)"object"==typeof this[r]&&(this[r]=copy(this[r]));this.init&&this.init.apply(this,arguments)}return this}var o=this.prototype;t=!0;var a=new this;t=!1;for(var s in i)"function"==typeof i[s]&&"function"==typeof o[s]&&n.test(i[s])?a[s]=function(t,n){return function(){var r=this.parent;this.parent=o[t];var i=n.apply(this,arguments);return this.parent=r,i}}(s,i[s]):a[s]=i[s];return e.prototype=a,e.constructor=e,e.extend=arguments.callee,e.inject=r,e}}(),newGuid_short=function(){var t=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return t().toString()};
/* End */
 
/*
* Box2D.js
* 2D Physics library.
* @author Erin Catto http://www.gphysics.com
*/ 
/* Start */
var Box2D = {};
...
(function () {
   ...
   b2ContactFilter.prototype.ShouldCollide = function (fixtureA, fixtureB) {
      ...
      */
      var collide = (filter1.groupIndex>filter2.groupIndex)?(filter1.groupIndex%filter2.groupIndex==0):(filter2.groupIndex%filter1.groupIndex==0);
      collide = collide && (fixtureA.GetBody().zGroup==fixtureB.GetBody().zGroup);
      return collide;
   }
   ...
   b2World.prototype.ClearForces = function () {
      for (var body = this.m_bodyList; body; body = body.m_next) {
         ...
         body.m_torque = 0.0;
         if(body.IsActive() && body.update) body.update();
      }
   }
   ...
   b2World.prototype.DrawShape = function (shape, xf, color, body) {
      switch (shape.m_type) {
      case b2Shape.e_circleShape:
         {
            var circle = ((shape instanceof b2CircleShape ? shape : null));
            ...
            var axis = xf.R.col1;
            this.m_debugDraw.DrawSolidCircle(center, radius, axis, color, body);
         }
         break;
      case b2Shape.e_polygonShape:
         {
            ...
            this.m_debugDraw.DrawSolidPolygon(vertices, vertexCount, color, body); 
         }
         break;
      case b2Shape.e_edgeShape:
         {
            var edge = (shape instanceof b2EdgeShape ? shape : null);
            this.m_debugDraw.DrawSegment(b2Math.MulX(xf, edge.GetVertex1()), b2Math.MulX(xf, edge.GetVertex2()), color, body);
         }
         break;
      }
   }
...
(function () {
   ...
   b2DebugDraw.prototype.DrawPolygon = function (vertices, vertexCount, color, body) {
   ...
   b2DebugDraw.prototype.DrawSolidPolygon = function (vertices, vertexCount, color, body) { 
      if (!vertexCount) return;
      var s = this.m_ctx; 
      var drawScale = this.m_drawScale;
      s.beginPath();
   ...
   b2DebugDraw.prototype.DrawCircle = function (center, radius, color, body) { 
      if (!radius) return;
      var s = this.m_ctx; 
      var drawScale = this.m_drawScale;
      s.beginPath();
   ...
   b2DebugDraw.prototype.DrawSolidCircle = function (center, radius, axis, color, body) { 
      if (!radius) return;
      var s = this.m_ctx,
...
* gGameEngineClass.js
* Game Engine.
* @author Geraud NT http://www.generisengine.appspot.com
*/ 
/* Start */
   ...
   add: function(type, params) {
   		switch(type.toLowerCase()) {
   			case "event":
   				break;
   			case "eventlistener":
   				if(!this.eventListeners[params.id]) this.eventListeners[params.id] = [];
   				this.eventListeners[params.id].push({pre: (params.pre||function(){}).bind(this), post: (params.post||function(){}).bind(this)});
   				break;
   			case "scene":
   				break;
   		}
...
SceneEngineClass = Class.extend({
   ...
   setup: function ( ) {
        ...
        this.Physics.addContactListener({
         ...
         BeginContact: function(idA, idB) {
            ...
            PostSolve: function (bodyA, bodyB, impulse, contact) {
               ...
               var entityA = This.entities[uA.id];
            var entityB = This.entities[uB.id]; 
      ...
      this.gHelperEngine = new HelperEngineClass(this.id); 
      ...
      this.Physics.bTest(60, false, canvasWidth, canvasHeight, SCALE);
   ...
   new: function(type, params) {
   		switch(type.toLowerCase()) {
            case "camera":
               ...
               params.y = params.y||0;
               params.z = params.z||0;
               var camera = new CameraClass(this.id, params);
               this.cameras[camera.id] = camera;
               this.activeCamera = camera.id;
               return camera;
   			case "entity": 
		    ...
		    case "event":
		    	if(!params.id) {
			        ...
			        if(mm<10) mm='0'+mm; 
			        today = mm +dd +yyyy;   
			        params.id = "event_" + today + t;
				}
				if(!params.start)  params.start = function() { return true; };
				if(!params.stop)  params.stop = function() { return false; };
   		...
   		switch(type.toLowerCase()) {
			...
			case "event":
				delete this.events[params.id];
   				break;
			case "eventlistener":
				delete this.eventListeners[params.id];
   				break;
   		}
   }, 
   ...
   load: function(type, params) {
    ...
    update: function (animStart) {
    	...
    	for (var event in this.events) {   
    		var e2 = this.eventListeners[event];
    		if(e2 && this.events[event].event()) for (var i = 0; i < e2.length; i++) {
			    	  	e2[i].pre();
			    	};
			  continue;
    		if(this.events[event].on) {
    			if(this.events[event].stop()) {
    				this.events[event].on = false;
    		...
    		} else if(this.events[event].start()) {
    			this.events[event].event();
    			this.events[event].on = true;
    			if(e2) for (var i = 0; i < e2.length; i++) {
		    	  	e2[i].pre();
		    	}; 
    		} 
...
/*
* gCameraEngineClass.js
* Entity Engine.
* @author Geraud NT http://www.generisengine.appspot.com
*/ 
/* Start */

CameraClass = Class.extend({
   id: null, 
   time:0,
   position:{},
   size:{}, 
   ...
   set: function(type, params) {
         ...
         switch(type.toLowerCase()) { 
            case "position": 
               if(params.x!=undefined) this.position.x = params.x;
               if(params.y!=undefined) this.position.y = params.y;
               if(params.z!=undefined) this.position.z = params.z;
               break;
            case "size":
               if(params.width!=undefined) this.position.width = params.width;
               if(params.height!=undefined) this.position.height = params.height; 
               break;
         }
   },
   ...
   get: function(type, params) {
         switch(type.toLowerCase()) { 
            ...
            case "event":
               return this.events[params.id]; 
            case "eventlistener":
               return this.eventListeners[params.id];
            case "time":
               return this.time; 
         }
   },
...
EntityClass = Class.extend({
    ...
    init: function ( sceneId, params ) {  
		...
		for(var key in params.bodies) {
			var param = params.bodies[key];
			param.type = param.type||"static";
			param.angle = param.angle||param.angle;
			param.color = param.color||param.color;
			param.strength = param.strength||param.strength;  
			param.x = param.x||0;
			param.y = param.y||0;
			param.z = param.z||0;
			param.alpha = param.alpha||1;
			param.width = param.width||100;
			param.height = param.height||100;
			if(!param.offset) param.offset = {};
			if(!param.offset.position) param.offset.position = {x: 0,y: 0,z:0};
			if(!param.offset.size) param.offset.size = {width: 0, height: 0};
			if(param.radius) { 
			...
			param.width = 0;
			param.height = 0;
				for (var i = 0; i < param.polys.length; i++) 
					for (var j = 0; j < param.polys[i].length; j++) { 
						if(Math.abs(param.polys[i][j].x) > param.width) param.width = Math.abs(param.polys[i][j].x);
						if(Math.abs(param.polys[i][j].y) > param.height) param.height = Math.abs(param.polys[i][j].y);
					}
			}
      ...
      this.eDraw = param.eDraw;
    	...
    	this.entityDef.sceneId = this.sceneId;
        this.body = scene.Physics.addBody(this.entityDef);
        this.body.update = update.bind(this);
     	this.body.draw = draw.bind(this);
     	this.body.eDebugDraw = this.eDebugDraw;
     	this.body.eDraw = this.eDraw;
      this.body.zGroup = param.z;
         ...
         if(This.size.radius){
			...
			var frames = This.bodies[This.activeBody].frames;    

			if ( This.activeBody != "" && frames && frames.length > 0 && This.showImage ) {  
			      if ( This.useImageSize ) { 
			         if(Posx > scene.cameras[scene.activeCamera].position.x + scene.cameras[scene.activeCamera].size.width) return;
			         if(Posy > scene.cameras[scene.activeCamera].position.y + scene.cameras[scene.activeCamera].size.height) return;

			         drawSprite(ctx, This, frames[This.frame], Posx , Posy);  
			      } else {   
			         if(Posx + Width < scene.cameras[scene.activeCamera].position.x) return;
			         if(Posy + Height < scene.cameras[scene.activeCamera].position.y) return;
			         if(Posx - Width/2 > scene.cameras[scene.activeCamera].position.x + scene.cameras[scene.activeCamera].size.width) return;
			         if(Posy - Height/2 > scene.cameras[scene.activeCamera].position.y + scene.cameras[scene.activeCamera].size.height) return;
			         
			         drawSprite(ctx, This, frames[This.frame],  Posx , Posy, Width, Height);
			      }  
				...
				Posx += This.offset.position.x;
				Posy += This.offset.position.y;
				Width += This.offset.size.width;
				Height += This.offset.size.height;
				if ( This.updateType == "cutting" ) { 
				   var dw = ( ww * This.srcSzOffset.width )/100;
				   var dh = ( hh * This.srcSzOffset.height )/100; 
				   var dwidth = ( Width * This.srcSzOffset.width )/100;
				   var dheight = ( Height * This.srcSzOffset.height )/100; 
				   ww -= dw;
				   hh -= dh; 
				   width -=   dwidth ;
				   height -=   dheight ; 
     	...
     	function update () { 
    	 	...
    	 	*/
     		var param = This.body.GetPosition();
         var position = new b2Vec3();
         position.x = param.x*30;
   ...
   add: function(type, params) {
   		switch(type.toLowerCase()) {
   			...
   			case "eventlistener":
                ...
                break;
   			case "frame":
   				this.bodies[this.activeBody].frames.push(params.frames);
   				break;
   			case "body":
   				this.bodies[params.id] = params.body;
   				break;
         ...
         var scene = G.scenes[this.sceneId];
   		switch(type.toLowerCase()) {
            case "position":
               ...
               if(params.x!=undefined) position.x = params.x/30;
               if(params.y!=undefined) position.y = params.y/30;
               if(params.z || params.z==0) { 
                  this.body.zGroup = params.z;
                  this.position.z = params.z;
               }  
            ...
            case "size":
               ...
               if(params.size) this.offset.size = params.size;
               if(params.angle) this.offset.angle = params.angle;
   				break;
   			case "alpha":
   				this.alpha = params.alpha;
   				break;
   			case "frames":
   				this.bodies[this.activeBody].frames = params.frames;
   				break;
   			case "body":   
               this.activeBody = params.id; 
               this.frame = 0 ;

               var param = this.bodies[params.id]; 
               param.id = params.id;
               param.sceneId = this.sceneId;
               this.position = {
                  x: param.x,
               ...
               this.entityDef.groupIndex = param.groupIndex||1;
               this.entityDef.sceneId = this.sceneId;
               var update = this.body.update;
               var draw = this.body.draw;
               this.body = scene.Physics.chngBodyFix(this.body, this.entityDef);
               this.body.zGroup = param.z; 
   				break;
   		}
   },
   ...
   get: function(type, params) {
   		switch(type.toLowerCase()) {
            ...
            case "alpha":
               return this.alpha; 
            case "frames":
               return this.bodies[this.activeBody].frames;
               break;
            case "body":   
               return this.body;
   			case "event":
...
PhysicsEngineClass = Class.extend({
    ...
    init: function ( sceneId ) {
      ...
      this.gravity = new b2Vec2(this.gravity.x, this.gravity.y);
        ...
        if ( this.debugDraw) { 
         ...
         debugDraw.SetSprite(scene.Renderer.context);
   ...
   update : function() {
     ...
     this.world.Step(
      ...
      this.world.ClearForces(G.scenes[this.sceneId]); 
   ...
   setBodies : function(bodyEntities) {
      /*for(var id in bodyEntities) {
         ...
         var efct = G.spawnEntity(id, settings1);
      } */
      this.ready = true;
   },
   ...
   addBody : function(entity) {
     ...
     else bodyDef.userData = { "id": entity.id, "sceneId": entity.sceneId}; 
     bodyDef.userData.id = entity.id;  
     bodyDef.userData.sceneId = entity.sceneId;  

     var body = this.registerBody(bodyDef);
     
     if ( body != null ) {  
      var fixtureDef = new b2FixtureDef;
      fixtureDef.density = entity.density||1;
      fixtureDef.friction = entity.friction||1;
      fixtureDef.restitution = entity.restitution||0;  
      fixtureDef.filter.groupIndex = entity.groupIndex; 
   ...
   chngBodyFix : function(body, entity) {
     ...
     if ( body != null ) {
      ...
      fixtureDef.friction = entity.friction||0.5;
      fixtureDef.restitution = entity.restitution||0.2; 
      fixtureDef.filter.groupIndex = entity.groupIndex; 
   ...
   addPulleyJoint : function(body1Id, body2Id, groundAnchor1, groundAnchor2, params) {
     var body1 = this.bodiesMap[body1Id];
     var body2 = this.bodiesMap[body2Id];
     var ga1 = new b2Vec2(groundAnchor1.x/SCALE, groundAnchor1.y/SCALE);
     var ga2 = new b2Vec2(groundAnchor2.x/SCALE, groundAnchor2.y/SCALE);
   ...
   mouseDownAt : function(x, y) {
     if (!this.mouseJoint) {
       ...
       if (body) {
        ...
        this.mouseJoint.SetTarget(new b2Vec2(x/SCALE, y/SCALE));
     }
   },
   ...
   getBodyAt : function(x, y) {
      var mousePVec = new b2Vec2(x/SCALE, y/SCALE);
      var aabb = new b2AABB();
   ...
   addJoint : function(body1Id, body2Id, anchor) {
      var body1 = this.bodiesMap[body1Id];
      var body2 = this.bodiesMap[body2Id];
      var joint = new b2RevoluteJointDef();
      if(anchor) joint.Initialize(body1, body2, anchor);
      else joint.Initialize(body1, body2, body1.GetWorldCenter());
      this.world.CreateJoint(joint);
   },
  ...
  resizeGame: function() {  
    try {    
       ...
       if(!scene.activeCamera) return;
		...
		var rWidth = This.canvas.width/scene.cameras[scene.activeCamera].size.width;
		var rHeight = This.canvas.height/scene.cameras[scene.activeCamera].size.height;

		ctx.scale( rWidth, rHeight);
		ctx.translate( -scene.cameras[scene.activeCamera].position.x, -scene.cameras[scene.activeCamera].position.y );  
	} catch(e){}
...
/* RendererClass.js End */


/*
* gHelperEngineClass.js
* 2D Helper Engine.
*/ 
/* Start */
...
HelperEngineClass = Class.extend({
   ...
   init: function ( sceneId ) {
      ...
      Entity.build = function(def) {
		...
		def.x = ( ( def.x )/SCALE ) ;//+ ( ( def.size.width/SCALE )/2 );
		def.y = ( ( def.y )/SCALE ) ;//+ ( ( def.size.height/SCALE )/2 ); 
        ...
        if (def.radius) {
          ...
          return new RectangleEntity(def.id, def.type, def.x, def.y, def.angle, NULL_CENTER, def.color, def.strength, def.width, def.height);
        }
      }
      ...
      function RectangleEntity(id, type, x, y, angle, center, color, strength, width, height) {
        Entity.call(this, id, type, x, y, angle, center, color, strength);
        this.halfWidth = (width/SCALE)/2;
        this.halfHeight = (height/SCALE)/2;
      }
      ...
      function PolygonEntity(id, type, x, y, angle, center, color, strength, polys) {
        ...
        for (var i = polys.length - 1; i >= 0; i--) {
        	for (var j = polys[i].length - 1; j >= 0; j--) {
	        	for(var key in polys[i][j]) polys[i][j][key] /= SCALE
	        };
        };
        this.polys = polys;
      }
      ...
      function update(animStart) {
        if (!drawToggle.isDrawing()) {
          if (isMouseDown) {
             Physics.mouseDownAt(mouseX, mouseY);
          } else if ( Physics.isMouseDown()) {
             Physics.mouseUp();
          }
        } else {
          if (isMouseDown) {
            selectedId =  Physics.getBodyIdAt(mouseX, mouseY);
          }
        ...
        Physics.update();
        this.bodiesState =  Physics.getState();
      ...
      function initialise() {
         ...
         Physics.addContactListener({
            ...
            PostSolve: function(idA, idB, impulse) {
              ...
              //console.log(idA + ' __ ' + idB);
               var entityA = scene.objects[idA];
               var entityB = scene.objects[idB];
           ...
           */
           ...
           //setTimeout(function() {
             ...
             //Physics.applyImpulse("Player", 70, 35);
      ...
      function handleMouseMove(e) {
         ...
         mouseX = (e.clientX - Renderer.canvas.getBoundingClientRect().left);
         mouseY = (e.clientY - Renderer.canvas.getBoundingClientRect().top);

         if( Renderer.showWorld == false ) {
         
         var rWidth = Renderer.canvas.width/scene.cameras[scene.activeCamera].size.width;
         var rHeight = Renderer.canvas.height/scene.cameras[scene.activeCamera].size.height;
...
/* gHelperEngineClass End */



/*
* gInputEngineClass.js
* 2D Helper Engine.
*/ 
/* Start */
   ...
   delListeners: function(listeners) {
      if(listeners) {
         for(var l in listeners) {
            window.removeEventListener(listeners[l].event, listeners[l].function);
         }
      } else {
         // Adding the event listeners for the appropriate DOM events.
...
/*
* gHInputEngineClass.js End */

/*
* gSoundEngineClass.js
* 2D Helper Engine.
*/ 
/* Start */
   ...
   if(entity.bodies[entity.activeBody].useSpriteSheet) {
      for(var sheetName in gSpriteSheets) {
           ...
           if(sprite === null) continue; 
            __drawSpriteInternal(ctx, entity, sprite, sheet, posX, posY, width, height );
      ...
      if(!sheet) {
      	var Sprites = new SpriteSheetClass(); 
        Sprites.load(spritename, function(img) { __drawSpriteInternal(ctx, entity, img, sheet, posX, posY, width, height ); }); 
      } else
      	__drawSpriteInternal(ctx, entity, sheet.img, sheet, posX, posY, width, height ); 
   }
   
}

function __drawSpriteInternal(ctx, entity, spt, sheet, posX, posY, width, height ) {
   
   posX += entity.offset.position.x;
   posY += entity.offset.position.y;
